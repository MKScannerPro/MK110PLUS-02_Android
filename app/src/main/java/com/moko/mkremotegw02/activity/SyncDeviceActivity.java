...
import com.moko.mkremotegw02.adapter.SyncDeviceAdapter;
import com.moko.mkremotegw02.base.BaseActivity;
import com.moko.mkremotegw02.databinding.ActivityDevicesBinding;
import com.moko.mkremotegw02.db.DBTools02;
import com.moko.mkremotegw02.dialog.LogoutDialog;
...
import com.moko.mkremotegw02.net.entity.SyncDevice;
...
public class SyncDeviceActivity extends BaseActivity<ActivityDevicesBinding> implements BaseQuickAdapter.OnItemClickListener {
    ...
    private void syncDevices(List<SyncDevice> syncDevices) {
        ...
        OkGo.<String>post(Urls.syncGatewayApi(getApplicationContext()))
                .upRequestBody(body)
                .headers("Authorization", RemoteMainWithMetering02Activity.mAccessToken)
