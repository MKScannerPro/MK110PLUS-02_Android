...
import com.moko.mkremotegw02.databinding.ActivityScanAndUpload02Binding;
...
public class ScanAndUploadActivity extends BaseActivity<ActivityScanAndUpload02Binding> implements SeekBar.OnSeekBarChangeListener {
    ...
    @Override
    protected ActivityScanAndUpload02Binding getViewBinding() {
        return ActivityScanAndUpload02Binding.inflate(getLayoutInflater());
    }
