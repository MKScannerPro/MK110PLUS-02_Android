...
import com.moko.mkremotegw02.databinding.ActivityOta02Binding;
...
public class OTA02Activity extends BaseActivity<ActivityOta02Binding> {
    ...
    @Override
    protected ActivityOta02Binding getViewBinding() {
        return ActivityOta02Binding.inflate(getLayoutInflater());
    }
