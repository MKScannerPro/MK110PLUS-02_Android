...
import com.moko.mkremotegw02.databinding.ActivityPowerMetering02Binding;
 ...
 * @des:
 */
public class PowerMetering02Activity extends BaseActivity<ActivityPowerMetering02Binding> {
    ...
    @Override
    protected ActivityPowerMetering02Binding getViewBinding() {
        return ActivityPowerMetering02Binding.inflate(getLayoutInflater());
    }
    ...
    protected void onCreate() {
        ...
        mBind.layoutMeteringSwitch.setOnClickListener(v -> {
            ...
            Intent i = new Intent(this, MeteringSettings02Activity.class);
