...
import com.moko.mkremotegw02.databinding.ActivityMkPirSensorParams02Binding;
...
public class MKPIRSensorParamsActivity extends BaseActivity<ActivityMkPirSensorParams02Binding> {
    ...
    @Override
    protected ActivityMkPirSensorParams02Binding getViewBinding() {
        return ActivityMkPirSensorParams02Binding.inflate(getLayoutInflater());
    }
