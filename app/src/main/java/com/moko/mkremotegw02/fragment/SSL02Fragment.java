...
public class SSL02Fragment extends Fragment {
    ...
    private static final String TAG = SSL02Fragment.class.getSimpleName();
    private FragmentSslApp02Binding mBind;
    ...
    public SSL02Fragment() {
    }

    public static SSL02Fragment newInstance() {
        return new SSL02Fragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mBind = FragmentSslApp02Binding.inflate(inflater, container, false);
