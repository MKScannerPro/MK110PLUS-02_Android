...
public class AppConstants {
    ...
    // action
    public static final String ACTION_FINISH_ACTIVITY = "com.moko.mkremotegw02.action.finishActivity";
    public static final String ACTION_MODIFY_NAME = "com.moko.mkremotegw02.action.ACTION_MODIFY_NAME";
    public static final String ACTION_DELETE_DEVICE = "com.moko.mkremotegw02.action.ACTION_DELETE_DEVICE";
    public static final String ACTION_DEVICE_STATE = "com.moko.mkremotegw02.action.ACTION_DEVICE_STATE";
    // sp
