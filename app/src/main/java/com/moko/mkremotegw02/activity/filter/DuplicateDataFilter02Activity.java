...
import com.moko.mkremotegw02.databinding.ActivityDuplicateDataFilter02Binding;
...
public class DuplicateDataFilter02Activity extends BaseActivity<ActivityDuplicateDataFilter02Binding> {
    ...
    @Override
    protected ActivityDuplicateDataFilter02Binding getViewBinding() {
        return ActivityDuplicateDataFilter02Binding.inflate(getLayoutInflater());
    }
