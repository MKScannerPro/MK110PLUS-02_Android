...
import com.moko.mkremotegw02.databinding.ActivityFilterUrl02Binding;
...
public class FilterUrl02Activity extends BaseActivity<ActivityFilterUrl02Binding> {
    ...
    @Override
    protected ActivityFilterUrl02Binding getViewBinding() {
        return ActivityFilterUrl02Binding.inflate(getLayoutInflater());
    }
