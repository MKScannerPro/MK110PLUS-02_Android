...
import com.moko.mkremotegw02.activity.AdvertiseIBeacon02Activity;
...
public class DeviceSetting02Activity extends BaseActivity<ActivityDeviceSetting02Binding> {
    ...
    public void onIndicatorSettings(View view) {
        ...
        Intent i = new Intent(this, IndicatorSetting02Activity.class);
    ...
    public void onNetworkStatusReportInterval(View view) {
        ...
        Intent i = new Intent(this, NetworkReportInterval02Activity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startActivity(i);
    }
    ...
    public void onReconnectTimeout(View view) {
        ...
        Intent i = new Intent(this, ReconnectTimeout02Activity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startActivity(i);
    }
    ...
    public void onCommunicationTimeout(View view) {
        ...
        Intent i = new Intent(this, CommunicationTimeout02Activity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startActivity(i);
    }
    ...
    public void onDataReportTimeout(View view) {
        ...
        Intent i = new Intent(this, DataReportTimeout02Activity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startActivity(i);
    }
    ...
    public void onSystemTime(View view) {
        ...
        Intent i = new Intent(this, SystemTime02Activity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startActivity(i);
    }
    ...
    public void onButtonReset(View view) {
        ...
        Intent i = new Intent(this, ButtonReset02Activity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startActivity(i);
    }
    ...
    public void onOTA(View view) {
        ...
        Intent intent = new Intent(this, OTA02Activity.class);
    ...
    public void onModifyMqttSettings(View view) {
        ...
        Intent i = new Intent(this, ModifySettings02Activity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startActivity(i);
    }
    ...
    public void onDeviceInfo(View view) {
        ...
        Intent i = new Intent(this, DeviceInfo02Activity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startActivity(i);
    }
    ...
    public void onAdvertiseIBeacon(View view) {
        ...
        Intent i = new Intent(this, AdvertiseIBeacon02Activity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startActivity(i);
    }
