...
public class ScannerFilter02Activity extends BaseActivity<ActivityScannerFilter02Binding> implements SeekBar.OnSeekBarChangeListener {
    ...
    @Override
    protected ActivityScannerFilter02Binding getViewBinding() {
        return ActivityScannerFilter02Binding.inflate(getLayoutInflater());
    }
