...
public class FilterTLM02Activity extends BaseActivity<ActivityFilterTlm02Binding> {
    ...
    @Override
    protected ActivityFilterTlm02Binding getViewBinding() {
        return ActivityFilterTlm02Binding.inflate(getLayoutInflater());
    }
