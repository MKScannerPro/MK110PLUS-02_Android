package com.moko.mkremotegw02.utils;
...
public class Utils {
    ...
    public static File getFile(String fileName) {
        String devicePath = RemoteMainWithMetering02Activity.PATH_LOGCAT + File.separator + fileName;
     ...
     * @ClassPath com.moko.mkremotegw02.utils.Utils
     */
        ...
        if (files.length == 1) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                ...
                if (BuildConfig.IS_LIBRARY) {
                    ...
                    uri = FileProvider.getUriForFile(context, "com.moko.mkremotegw02.fileprovider", files[0]);
                }
            ...
            for (File file : files) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    ...
                    if (BuildConfig.IS_LIBRARY) {
                        ...
                        fileUri = FileProvider.getUriForFile(context, "com.moko.mkremotegw02.fileprovider", file);
                    }
                }
                uris.add(fileUri);
