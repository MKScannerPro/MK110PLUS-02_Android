...
import com.moko.mkremotegw02.databinding.ActivityBxpCThSampleRate02Binding;
...
public class BXPCTHSampleRateActivity extends BaseActivity<ActivityBxpCThSampleRate02Binding> {
    ...
    @Override
    protected ActivityBxpCThSampleRate02Binding getViewBinding() {
        return ActivityBxpCThSampleRate02Binding.inflate(getLayoutInflater());
    }
