...
import com.moko.mkremotegw02.databinding.ActivityBxpDInfo02Binding;
...
public class BXPDActivity extends BaseActivity<ActivityBxpDInfo02Binding> {
    ...
    @Override
    protected ActivityBxpDInfo02Binding getViewBinding() {
        return ActivityBxpDInfo02Binding.inflate(getLayoutInflater());
    }
