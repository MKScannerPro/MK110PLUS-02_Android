...
import com.moko.mkremotegw02.databinding.ActivityBeaconDfu02Binding;
...
import com.moko.support.remotegw02.entity.BleInfo;
...
public class BeaconDFUv2Activity extends BaseActivity<ActivityBeaconDfu02Binding> {
    ...
    @Override
    protected ActivityBeaconDfu02Binding getViewBinding() {
        return ActivityBeaconDfu02Binding.inflate(getLayoutInflater());
    }
