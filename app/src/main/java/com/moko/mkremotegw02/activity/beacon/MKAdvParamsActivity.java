...
import com.moko.mkremotegw02.databinding.ActivityMkAdvParams02Binding;
...
public class MKAdvParamsActivity extends BaseActivity<ActivityMkAdvParams02Binding> {
    ...
    @Override
    protected ActivityMkAdvParams02Binding getViewBinding() {
        return ActivityMkAdvParams02Binding.inflate(getLayoutInflater());
    }
