...
import com.moko.mkremotegw02.dialog.BeaconTypeDialog;
...
public class BleManager02V2Activity extends BaseActivity<ActivityBleDevices02Binding> implements BaseQuickAdapter.OnItemChildClickListener {
...
//        }
    ...
    public void onDeviceModifyNameEvent(DeviceModifyNameEvent event) {
        // 修改了设备名称
        MokoDevice device = DBTools02.getInstance(BleManager02V2Activity.this).selectDevice(mMokoDevice.mac);
...
//        });
    ...
    public void onFilter(View view) {
        ...
        scanFilterDialog.setOnScanFilterListener((filterName, filterMac, filterRssi) -> {
            BleManager02V2Activity.this.filterName = filterName;
            BleManager02V2Activity.this.filterMac = filterMac;
            BleManager02V2Activity.this.filterRssi = filterRssi;
            if (!TextUtils.isEmpty(filterName)
                    || !TextUtils.isEmpty(filterMac)
                    || filterRssi != -127) {
        ...
        typeDialog.setBeaconTypeListener(type -> {
            ...
            if (type == 0) {
                ...
                dialog.setOnPasswordClicked(password -> {
                    ...
                    mHandler.postDelayed(() -> {
                        dismissLoadingProgressDialog();
                        ToastUtils.showToast(BleManager02V2Activity.this, "Setup failed");
                    }, 50 * 1000);
                    showLoadingProgressDialog();
