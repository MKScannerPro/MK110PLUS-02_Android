...
import com.moko.mkremotegw02.databinding.ActivityMkPirInfo02Binding;
...
public class MKPIRActivity extends BaseActivity<ActivityMkPirInfo02Binding> {
    ...
    @Override
    protected ActivityMkPirInfo02Binding getViewBinding() {
        return ActivityMkPirInfo02Binding.inflate(getLayoutInflater());
    }
