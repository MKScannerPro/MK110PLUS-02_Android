...
import com.moko.mkremotegw02.databinding.ActivityAdvSettings02Binding;
 ...
 * @des:
 */
public class AdvSettingsActivity extends BaseActivity<ActivityAdvSettings02Binding> implements SeekBar.OnSeekBarChangeListener {
    ...
    @Override
    protected ActivityAdvSettings02Binding getViewBinding() {
        return ActivityAdvSettings02Binding.inflate(getLayoutInflater());
    }
