...
import com.moko.mkremotegw02.databinding.ActivityFilterBxpButton02Binding;
...
public class FilterBXPButton02Activity extends BaseActivity<ActivityFilterBxpButton02Binding> {
    ...
    protected void onCreate() {
        ...
        mHandler.postDelayed(() -> {
            ...
            FilterBXPButton02Activity.this.finish();
        }, 30 * 1000);
    ...
    @Override
    protected ActivityFilterBxpButton02Binding getViewBinding() {
        return ActivityFilterBxpButton02Binding.inflate(getLayoutInflater());
    }
