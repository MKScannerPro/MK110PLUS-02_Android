...
import com.moko.mkremotegw02.databinding.ActivityFilterPir02Binding;
...
public class FilterPIR02Activity extends BaseActivity<ActivityFilterPir02Binding> {
    ...
    @Override
    protected ActivityFilterPir02Binding getViewBinding() {
        return ActivityFilterPir02Binding.inflate(getLayoutInflater());
    }
