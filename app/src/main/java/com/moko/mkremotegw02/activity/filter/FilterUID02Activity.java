...
import com.moko.mkremotegw02.databinding.ActivityFilterUid02Binding;
...
public class FilterUID02Activity extends BaseActivity<ActivityFilterUid02Binding> {
    ...
    @Override
    protected ActivityFilterUid02Binding getViewBinding() {
        return ActivityFilterUid02Binding.inflate(getLayoutInflater());
    }
