...
import com.moko.mkremotegw02.databinding.ActivityReconnectTimeout02Binding;
...
public class ReconnectTimeout02Activity extends BaseActivity<ActivityReconnectTimeout02Binding> {
    ...
    @Override
    protected ActivityReconnectTimeout02Binding getViewBinding() {
        return ActivityReconnectTimeout02Binding.inflate(getLayoutInflater());
    }
