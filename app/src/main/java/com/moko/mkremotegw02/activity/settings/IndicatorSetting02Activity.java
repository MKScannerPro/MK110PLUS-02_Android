package com.moko.mkremotegw02.activity.settings;
...
import com.moko.mkremotegw02.databinding.ActivityIndicatorSetting02Binding;
...
public class IndicatorSetting02Activity extends BaseActivity<ActivityIndicatorSetting02Binding> {
    ...
    protected void onCreate() {
        ...
        mHandler.postDelayed(() -> {
            ...
            IndicatorSetting02Activity.this.finish();
        }, 30 * 1000);
    ...
    @Override
    protected ActivityIndicatorSetting02Binding getViewBinding() {
        return ActivityIndicatorSetting02Binding.inflate(getLayoutInflater());
    }
