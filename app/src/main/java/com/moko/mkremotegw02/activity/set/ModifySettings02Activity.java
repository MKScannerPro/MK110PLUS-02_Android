...
public class ModifySettings02Activity extends BaseActivity<ActivityModifySettings02Binding> {
    public static String TAG = ModifySettings02Activity.class.getSimpleName();
    ...
    @Override
    protected ActivityModifySettings02Binding getViewBinding() {
        return ActivityModifySettings02Binding.inflate(getLayoutInflater());
    }
    ...
    public void onMQTTMessageArrivedEvent(MQTTMessageArrivedEvent event) {
        ...
        if (msg_id == MQTTConstants.CONFIG_MSG_ID_REBOOT) {
            ...
            if (result.result_code == 0) {
                ...
                DBTools02.getInstance(this).updateDevice(mMokoDevice);
    ...
    public void onWifiSettings(View view) {
        ...
        Intent i = new Intent(this, ModifyWifiSettings02Activity.class);
    ...
    public void onMqttSettings(View view) {
        ...
        Intent i = new Intent(this, ModifyMQTTSettings02Activity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        launcher.launch(i);
    }
