...
import com.moko.mkremotegw02.databinding.ActivityBxpTInfo02Binding;
...
public class BXPTActivity extends BaseActivity<ActivityBxpTInfo02Binding> {
    ...
    @Override
    protected ActivityBxpTInfo02Binding getViewBinding() {
        return ActivityBxpTInfo02Binding.inflate(getLayoutInflater());
    }
