...
public class NtpSettings02Activity extends BaseActivity<ActivityNtpSettings02Binding> {
    ...
    @Override
    protected ActivityNtpSettings02Binding getViewBinding() {
        return ActivityNtpSettings02Binding.inflate(getLayoutInflater());
    }
