...
import com.moko.mkremotegw02.databinding.ActivityMeteringSettings02Binding;
 ...
 * @des:
 */
public class MeteringSettings02Activity extends BaseActivity<ActivityMeteringSettings02Binding> {
    ...
    @Override
    protected ActivityMeteringSettings02Binding getViewBinding() {
        return ActivityMeteringSettings02Binding.inflate(getLayoutInflater());
    }
