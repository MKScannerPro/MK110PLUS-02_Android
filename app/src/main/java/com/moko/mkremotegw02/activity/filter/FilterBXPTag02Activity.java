...
import com.moko.mkremotegw02.databinding.ActivityFilterBxpTag02Binding;
...
public class FilterBXPTag02Activity extends BaseActivity<ActivityFilterBxpTag02Binding> {
    ...
    @Override
    protected ActivityFilterBxpTag02Binding getViewBinding() {
        return ActivityFilterBxpTag02Binding.inflate(getLayoutInflater());
    }
        ...
        if (msg_id == MQTTConstants03.READ_MSG_ID_FILTER_BXP_TAG) {
            ...
            if (number != 0) {
                ...
                for (JsonElement jsonElement : tagList) {
                    ...
                    View v = LayoutInflater.from(FilterBXPTag02Activity.this).inflate(R.layout.item_mac_address_filter, mBind.llTagId, false);
