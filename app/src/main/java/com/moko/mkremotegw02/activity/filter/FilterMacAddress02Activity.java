...
import com.moko.mkremotegw02.databinding.ActivityFilterMacAddress02Binding;
...
public class FilterMacAddress02Activity extends BaseActivity<ActivityFilterMacAddress02Binding> {
    ...
    @Override
    protected ActivityFilterMacAddress02Binding getViewBinding() {
        return ActivityFilterMacAddress02Binding.inflate(getLayoutInflater());
    }
        ...
        if (msg_id == MQTTConstants.READ_MSG_ID_FILTER_MAC_ADDRESS) {
            ...
            if (number != 0) {
                ...
                for (JsonElement jsonElement : macList) {
                    ...
                    View v = LayoutInflater.from(FilterMacAddress02Activity.this).inflate(R.layout.item_mac_address_filter, mBind.llMacAddress, false);
