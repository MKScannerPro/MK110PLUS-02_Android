...
import com.moko.mkremotegw02.databinding.ActivityFilterIbeacon02Binding;
...
public class FilterIBeacon02Activity extends BaseActivity<ActivityFilterIbeacon02Binding> {
    ...
    @Override
    protected ActivityFilterIbeacon02Binding getViewBinding() {
        return ActivityFilterIbeacon02Binding.inflate(getLayoutInflater());
    }
