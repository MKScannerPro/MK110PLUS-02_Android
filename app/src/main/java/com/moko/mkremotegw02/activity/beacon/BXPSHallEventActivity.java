...
import com.moko.mkremotegw02.databinding.ActivityBxpSHallEvent02Binding;
...
public class BXPSHallEventActivity extends BaseActivity<ActivityBxpSHallEvent02Binding> {
    ...
    @Override
    protected ActivityBxpSHallEvent02Binding getViewBinding() {
        return ActivityBxpSHallEvent02Binding.inflate(getLayoutInflater());
    }
