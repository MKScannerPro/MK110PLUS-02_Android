...
import com.moko.mkremotegw02.databinding.ActivityCommunicationTimeout02Binding;
...
public class CommunicationTimeout02Activity extends BaseActivity<ActivityCommunicationTimeout02Binding> {
    ...
    @Override
    protected ActivityCommunicationTimeout02Binding getViewBinding() {
        return ActivityCommunicationTimeout02Binding.inflate(getLayoutInflater());
    }
