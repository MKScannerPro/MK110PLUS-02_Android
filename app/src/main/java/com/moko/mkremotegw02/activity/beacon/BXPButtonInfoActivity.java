...
public class BXPButtonInfoActivity extends BaseActivity<ActivityBxpButtonInfo02Binding> {
    ...
    @Override
    protected ActivityBxpButtonInfo02Binding getViewBinding() {
    ...
    public void onDeviceModifyNameEvent(DeviceModifyNameEvent event) {
        // 修改了设备名称
        MokoDevice device = DBTools02.getInstance(BXPButtonInfoActivity.this).selectDevice(mMokoDevice.mac);
