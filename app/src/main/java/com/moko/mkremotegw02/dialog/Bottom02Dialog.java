...
import com.moko.mkremotegw02.databinding.DialogBottom02Binding;

import java.util.ArrayList;

public class Bottom02Dialog extends MokoBaseDialog<DialogBottom02Binding> {
    private ArrayList<String> mDatas;
    private int mIndex;

    @Override
    protected DialogBottom02Binding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return DialogBottom02Binding.inflate(inflater, container, false);
    }
