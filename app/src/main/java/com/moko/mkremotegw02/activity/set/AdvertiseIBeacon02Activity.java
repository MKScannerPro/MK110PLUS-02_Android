...
import com.moko.mkremotegw02.databinding.ActivityAdvertiseIbeacon02Binding;
 ...
 * @des:
 */
public class AdvertiseIBeacon02Activity extends BaseActivity<ActivityAdvertiseIbeacon02Binding> {
    ...
    @Override
    protected ActivityAdvertiseIbeacon02Binding getViewBinding() {
        return ActivityAdvertiseIbeacon02Binding.inflate(getLayoutInflater());
    }
