...
import com.moko.mkremotegw02.databinding.FragmentSslDevice02Binding;
...
public class SSLDevice02Fragment extends Fragment {
    ...
    private static final String TAG = SSLDevice02Fragment.class.getSimpleName();
    private FragmentSslDevice02Binding mBind;
    ...
    public SSLDevice02Fragment() {
    }

    public static SSLDevice02Fragment newInstance() {
        return new SSLDevice02Fragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mBind = FragmentSslDevice02Binding.inflate(inflater, container, false);
