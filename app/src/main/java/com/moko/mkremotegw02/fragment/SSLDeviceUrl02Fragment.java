...
public class SSLDeviceUrl02Fragment extends Fragment {
    ...
    private FragmentSslDeviceUrl02Binding mBind;
    private ModifyMQTTSettings02Activity activity;
    ...
    public SSLDeviceUrl02Fragment() {
    }

    public static SSLDeviceUrl02Fragment newInstance() {
        return new SSLDeviceUrl02Fragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mBind = FragmentSslDeviceUrl02Binding.inflate(inflater, container, false);
        activity = (ModifyMQTTSettings02Activity) getActivity();
