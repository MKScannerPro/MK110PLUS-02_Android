...
import com.moko.mkremotegw02.databinding.ActivityMkTofAdvParams02Binding;
...
public class MKTOFAdvParamsActivity extends BaseActivity<ActivityMkTofAdvParams02Binding> {
    ...
    @Override
    protected ActivityMkTofAdvParams02Binding getViewBinding() {
        return ActivityMkTofAdvParams02Binding.inflate(getLayoutInflater());
    }
