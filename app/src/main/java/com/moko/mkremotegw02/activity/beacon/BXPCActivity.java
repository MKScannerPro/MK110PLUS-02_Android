...
import com.moko.mkremotegw02.databinding.ActivityBxpCInfo02Binding;
 ...
 * @des:
 */
public class BXPCActivity extends BaseActivity<ActivityBxpCInfo02Binding> {
    ...
    @Override
    protected ActivityBxpCInfo02Binding getViewBinding() {
        return ActivityBxpCInfo02Binding.inflate(getLayoutInflater());
    }
