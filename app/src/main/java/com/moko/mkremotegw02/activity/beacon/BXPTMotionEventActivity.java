...
import com.moko.mkremotegw02.databinding.ActivityBxpTMotionEvent02Binding;
...
public class BXPTMotionEventActivity extends BaseActivity<ActivityBxpTMotionEvent02Binding> {
    ...
    @Override
    protected ActivityBxpTMotionEvent02Binding getViewBinding() {
        return ActivityBxpTMotionEvent02Binding.inflate(getLayoutInflater());
    }
