...
import com.moko.mkremotegw02.databinding.ActivityMkTofSensorParams02Binding;
...
public class MKTOFSensorParamsActivity extends BaseActivity<ActivityMkTofSensorParams02Binding> {
    ...
    @Override
    protected ActivityMkTofSensorParams02Binding getViewBinding() {
        return ActivityMkTofSensorParams02Binding.inflate(getLayoutInflater());
    }
