...
import com.moko.mkremotegw02.databinding.ActivityDataReportTimeout02Binding;
...
public class DataReportTimeout02Activity extends BaseActivity<ActivityDataReportTimeout02Binding> {
    ...
    @Override
    protected ActivityDataReportTimeout02Binding getViewBinding() {
        return ActivityDataReportTimeout02Binding.inflate(getLayoutInflater());
    }
