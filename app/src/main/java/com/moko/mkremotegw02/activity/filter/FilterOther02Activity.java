...
import com.moko.mkremotegw02.databinding.ActivityFilterOther02Binding;
...
public class FilterOther02Activity extends BaseActivity<ActivityFilterOther02Binding> {
    ...
    @Override
    protected ActivityFilterOther02Binding getViewBinding() {
        return ActivityFilterOther02Binding.inflate(getLayoutInflater());
    }
        ...
        if (msg_id == MQTTConstants.READ_MSG_ID_FILTER_OTHER) {
            ...
            if (number > 0) {
                ...
                for (JsonElement jsonElement : ruleList) {
                    ...
                    View v = LayoutInflater.from(FilterOther02Activity.this).inflate(R.layout.item_other_filter_remote, mBind.llFilterCondition, false);
