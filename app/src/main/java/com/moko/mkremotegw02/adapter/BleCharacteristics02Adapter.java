...
public class BleCharacteristics02Adapter extends BaseMultiItemQuickAdapter<BleOtherChar, BaseViewHolder> {
    public BleCharacteristics02Adapter(List<BleOtherChar> data) {
        super(data);
