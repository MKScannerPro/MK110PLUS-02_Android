...
import com.moko.mkremotegw02.databinding.ActivityFilterAdvName02Binding;
...
public class FilterAdvName02Activity extends BaseActivity<ActivityFilterAdvName02Binding> {
    ...
    @Override
    protected ActivityFilterAdvName02Binding getViewBinding() {
        return ActivityFilterAdvName02Binding.inflate(getLayoutInflater());
    }
        ...
        if (msg_id == MQTTConstants03.READ_MSG_ID_FILTER_ADV_NAME) {
            ...
            if (number != 0) {
                ...
                for (JsonElement jsonElement : macList) {
                    ...
                    View v = LayoutInflater.from(FilterAdvName02Activity.this).inflate(R.layout.item_adv_name_filter, mBind.llDavName, false);
