...
import com.moko.mkremotegw02.databinding.ActivitySystemTime02Binding;
...
public class SystemTime02Activity extends BaseActivity<ActivitySystemTime02Binding> {
    ...
    @Override
    protected ActivitySystemTime02Binding getViewBinding() {
        return ActivitySystemTime02Binding.inflate(getLayoutInflater());
    }
    ...
    public void onSyncTimeFromNTP(View view) {
        ...
        Intent i = new Intent(this, SyncTimeFromNTP02Activity.class);
