...
import com.moko.mkremotegw02.databinding.ActivityButtonReset02Binding;
...
public class ButtonReset02Activity extends BaseActivity<ActivityButtonReset02Binding> {
    ...
    @Override
    protected ActivityButtonReset02Binding getViewBinding() {
        return ActivityButtonReset02Binding.inflate(getLayoutInflater());
    }
