...
public class ModifyNetworkSettings02Activity extends BaseActivity<ActivityNetworkSettings02Binding> {
    ...
    @Override
    protected ActivityNetworkSettings02Binding getViewBinding() {
        return ActivityNetworkSettings02Binding.inflate(getLayoutInflater());
    }
