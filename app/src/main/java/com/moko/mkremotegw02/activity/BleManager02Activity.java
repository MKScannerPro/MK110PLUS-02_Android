...
import com.moko.mkremotegw02.dialog.PasswordRemoteBleDialog;
import com.moko.mkremotegw02.dialog.ScanFilterDialog;
...
import com.moko.support.remotegw02.entity.BleDevice;
...
public class BleManager02Activity extends BaseActivity<ActivityBleDevices02Binding> implements BaseQuickAdapter.OnItemChildClickListener {
    private MokoDevice mMokoDevice;
    private MQTTConfig appMqttConfig;
    private String mAppTopic;
    private BleDevice02Adapter mAdapter;
    ...
    protected void onCreate() {
        ...
        mAdapter = new BleDevice02Adapter();
    ...
    @Override
    protected ActivityBleDevices02Binding getViewBinding() {
        return ActivityBleDevices02Binding.inflate(getLayoutInflater());
    }
    ...
    public void onDeviceModifyNameEvent(DeviceModifyNameEvent event) {
        // 修改了设备名称
        MokoDevice device = DBTools02.getInstance(BleManager02Activity.this).selectDevice(mMokoDevice.mac);
    ...
    public void onFilter(View view) {
        ...
        scanFilterDialog.setOnScanFilterListener((filterName, filterMac, filterRssi) -> {
            BleManager02Activity.this.filterName = filterName;
            BleManager02Activity.this.filterMac = filterMac;
            BleManager02Activity.this.filterRssi = filterRssi;
            if (!TextUtils.isEmpty(filterName)
                    || !TextUtils.isEmpty(filterMac)
                    || filterRssi != -127) {
        ...
        if (bleDevice.type_code == 7) {
            ...
            dialog.setOnPasswordClicked(password -> {
                ...
                mHandler.postDelayed(() -> {
                    dismissLoadingProgressDialog();
                    ToastUtils.showToast(BleManager02Activity.this, "Setup failed");
                }, 50 * 1000);
